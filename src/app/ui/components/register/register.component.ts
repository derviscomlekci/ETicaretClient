...
export class RegisterComponent extends BaseComponent implements OnInit {
  ...
  submitted:boolean=false;
   async onSubmit(user: User){
    ...
    if(result.succeeded){
      this.toastrService.message(result.message,"User Registration Succes",{
        messageType: ToasterMessageType.Success,
        position: ToasterMessagePosition.BottomRigt
      })
    }
    else{
      this.toastrService.message(result.message,"User Registration Fail",{
